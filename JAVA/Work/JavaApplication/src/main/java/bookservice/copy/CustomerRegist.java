...
public class CustomerRegist extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    CustomerRegist frame = new CustomerRegist();
    ...
    public CustomerRegist(BookService frame) {
        commonConstructor();
    }
        ...
        if (btnNewButton == null) {
        	...
        	btnNewButton.addActionListener(new ActionListener() {
        	    public void actionPerformed(ActionEvent e) {
        	        ...
        	        BookService.CustomerReg(cname, crrn1, crrn2, cpn1, cpn2, cpn3, cmail1, cmail2);
        	        dispose();
        	    }
        	});
