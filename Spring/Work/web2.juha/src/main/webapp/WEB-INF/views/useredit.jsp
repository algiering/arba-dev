...
$(document).ready(function() {
    ...
    $('.btn_regist').click(function(event){
        ...
        if (password_check == 1 && email_check == 1) {
    ...
    <div id="container">
        <div id="register_container">
            <div id="content">
                ...
                <div id="user_id">
                    <div>아이디</div>
                    <input type="text" class="user_id" name="" disabled="disabled">
                    <div id="btn"></div>
                </div>
            ...
            <div id="btn_container">
                <div id="btn_regist" class="btn_regist">정보 수정</div>
            </div>
            <div id="blank"></div>
        </div>
