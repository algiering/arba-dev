...
public class ModelArticle {
    ...
    public ModelArticle(Integer article_no, String article_title, String article_content, Integer article_hit,
            Date article_regdate, Date article_update, String board_id) {
        super();
        this.article_no = article_no;
        this.article_title = article_title;
        this.article_content = article_content;
    ...
    public String toString() {
        return "ModelArticle [article_no=" + article_no + ", article_title=" + article_title + ", article_content="
                + article_content + ", article_hit=" + article_hit + ", article_regdate=" + article_regdate
                + ", article_update=" + article_update + ", board_id=" + board_id + "]";
    }
}
