package com.exam09.phone.model;

public class ModelPhone {
    
    private String name         ;  // `name         ` VARCHAR(50) NULL DEFAULT NULL,
    private String manufacturer ;  // `manufacturer ` VARCHAR(50) NULL DEFAULT NULL,
    private Integer price        ;  // `price        ` INT(11) NULL DEFAULT NULL
