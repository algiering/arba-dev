...
public class ModelArticle implements Parcelable {
    ...
    public ModelArticle(Integer article_no, String article_title, String article_content, Integer article_hit, Date article_regdate, Date article_update, String board_id) {
        this.article_no = article_no;
        this.article_title = article_title;
        this.article_content = article_content;
        this.article_hit = article_hit;
