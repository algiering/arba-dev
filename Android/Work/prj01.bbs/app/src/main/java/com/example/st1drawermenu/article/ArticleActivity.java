package com.example.st1drawermenu.article;
...
import com.example.st1drawermenu.AppConstans;
import com.example.st1drawermenu.R;
import com.example.st1drawermenu.fragment.FragmentArticleData;
import com.example.st1drawermenu.fragment.FragmentArticleFree;
import com.example.st1drawermenu.fragment.FragmentArticleQna;
...
public class ArticleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTabLayout.addTab(mTabLayout.newTab().setIcon(android.R.drawable.ic_dialog_info));
        ...
        // ViewPager 스크롤시 TabLayout의 선택 아이템 변경
        mViewPager.addOnPageChangeListener(new TabLayout.TabLayoutOnPageChangeListener(mTabLayout));

        // TabLayout에서 Tab 변경시 ViewPager의 페이지도 변경
    ...
    private class ArticlePagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    return FragmentArticleFree.newInstance(AppConstans.TITLE_ARTICLE_FREE, "");
                case 1:
