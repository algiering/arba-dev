...
<<<<<<< HEAD:spring61.rest/src/main/java/com/spring61/rest/controller/RestController.java
...
=======
>>>>>>> 5d480877138ddf41dd798e5529b7801e30137acd:spring61.rest/src/main/java/com/spring61/rest/controller/RestBoardController.java
    ...
    @ResponseBody
    public ModelUser login(@RequestParam String userid, @RequestParam String passwd) {
    ...
    @ResponseBody
    public int logout(@RequestParam String userid) {
    ...
    @ResponseBody
    public int checkpassword(@RequestParam String userid, @RequestParam String passwd) {
    ...
    @ResponseBody
    public int updatepasswd(@RequestParam String userid, @RequestParam String currentPasswd, @RequestParam String newPasswd) {
    ...
    @ResponseBody
    public String getboardname( @RequestParam String boardcd) {
    ...
    @ResponseBody
    public int getboardtotalrecord( @RequestParam String searchWord) {
    ...
    @ResponseBody
    public List<ModelBoard> getBoardPaging(   @RequestParam String searchWord
    ...
    @ResponseBody
    public List<ModelBoard> getBoardList( @RequestParam String searchWord  ) {
    ...
    @ResponseBody
    public int getArticleTotalRecord( @RequestParam String boardcd, @RequestParam String searchWord) {
    ...
    @ResponseBody
    public String getArticleList( @RequestParam String boardcd
