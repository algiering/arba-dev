...
public class HttpPerson implements IPerson {
    ...
    private static final String HTTP_URL_CHECKID          = AppConstants.HTT_URL_BASE + "/rest/checkid";
    ...
    public int checkid(String id) {
        ...
        try {
            request = new HttpRequest(HTTP_URL_CHECKID);
            request.configPostType(HttpRequest.MineType.VALUES);
    ...
    // Response : JSONObject
    @Override
    public ModelPerson loginperson(String id, String pw) {
        ...
        try {
            ...
            if( httpCode == HttpURLConnection.HTTP_OK ) {
                        // request.getStringResponse();
                        // request.getJSONArrayResponse();
                response = request.getJSONObjectResponse();
            }

            // 형변환
            result = new Gson().fromJson(response.toString(), ModelPerson.class);
        } catch (IOException e) {
            e.printStackTrace();
        } catch (Exception e) {
            e.printStackTrace();
