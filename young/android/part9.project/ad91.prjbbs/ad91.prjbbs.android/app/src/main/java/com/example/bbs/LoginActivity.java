...
public class LoginActivity extends AppCompatActivity  {
    ...
    private class LoginTask extends  SiteAsyncTask<String, Integer, ModelPerson> {
        ...
        @Override
        protected ModelPerson doInBackground(String... strings) {
        ...
        @Override
        protected void onPostExecute(ModelPerson result) {
