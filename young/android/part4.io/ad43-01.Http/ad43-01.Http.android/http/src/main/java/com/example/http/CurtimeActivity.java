...
public class CurtimeActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_curtime);

        final EditText edtIpAddr = (EditText) findViewById(R.id.edt_ipaddr);
        Button btn_httpget = (Button) findViewById(R.id.btn_httpget);

        btn_httpget.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new HttpRequestAsyncTask().execute( edtIpAddr.getText().toString()  );
            }
        });
    }
    ...
    public class HttpRequestAsyncTask extends AsyncTask< String, Integer, String>{
        ...
        protected void onPreExecute() {
            ...
            waitDlg = new ProgressDialog( CurtimeActivity.this );
    ...
    private String request(String ip) {
        String result     = "";
        ...
        // 서버 주소.
        String weburl = String.format("http://%s/rest/currentversion", ip );
