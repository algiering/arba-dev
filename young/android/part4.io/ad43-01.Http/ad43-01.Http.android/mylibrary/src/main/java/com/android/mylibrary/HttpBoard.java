...
import com.android.mylibrary.network.*;
...
public class HttpBoard {
    private final String URL_LOGIN         = "http://10.0.2.1:8080/rest/login";
    private final String URL_ARTICLELIST   = "http://10.0.2.1:8080/board/articlelist";
    private final String URL_ARTICLEVIEW   = "http://10.0.2.1:8080/board/articleview";
    private final String URL_ARTICLEWRITE  = "http://10.0.2.1:8080/board/articlewrite";
    private final String URL_ARTICLEMODIFY = "http://10.0.2.1:8080/board/articlemodify";
    private final String URL_ARTICLEDELETE = "http://10.0.2.1:8080/board/articledelete";
