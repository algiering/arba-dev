...
public class Test3ImageHelper {
    ...
    //
    @Test
    public void convert_from_resource_to_drawable() throws Exception {
        Drawable myIcon = appContext.getDrawable(R.drawable.b);
        assertNotNull( myIcon );
    }


    //
    @Test
    public void convert_from_resource_to_bitmap() throws Exception {
        Bitmap bitmap = BitmapFactory.decodeResource(appContext.getResources(), R.drawable.b);
        assertNotNull( bitmap );
    }

    @Test
    public void convert_from_resource_to_imagefile() throws Exception {

        String path = Environment.getExternalStorageDirectory().getAbsolutePath();
        Bitmap bitmap = BitmapFactory.decodeResource(appContext.getResources(), R.drawable.b);
        boolean result = ImageHelper.saveBitmapFile(bitmap, new File(path +"/b.bmp") );

        assertNotNull( bitmap );
    }

    // 이미지를 base64 문자열로 변환
    // image --> byte array --> base64 encoding string
    @Test
    public void test_convert_imagefile_to_base64string() throws Exception {

        String path = Environment.getExternalStorageDirectory().getAbsolutePath();

        File imageFile = new File("d:\\b.bmp");
        String base64string = ImageHelper.convertFromImagefileToString( imageFile );

        assertNotNull( base64string );
        assertEquals(base64string, strimage);

        ImageHelper.saveTextFile(base64string, new File(path + "/base64string.txt") );
    }


    @Test
    public void test_convert_from_base64string_to_imagefile() throws Exception {

        String path = Environment.getExternalStorageDirectory().getAbsolutePath();
        ImageHelper.saveImageFile( strimage, new File(path + "/newimage.bmp"));
    }

    @Test
    public void test_convert_from_imagefile_to_BufferedImage() throws Exception {

        //Read the file to a BufferedImage
        File imagefile = new File("D:\\b.png");
    ...
    @Test
    public void test_convert_string_to_drawable() throws Exception {

        Drawable bmpimage = ImageHelper.getDrawable(strimage);

        assertNotNull( bmpimage );
    }
